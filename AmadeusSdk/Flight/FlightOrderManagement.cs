...
namespace AmadeusSdk.FlightOrderManagement
{
    ...
    public partial class Client
    {
        ...
        public System.Threading.Tasks.Task<Success_Booking> GetFlightOrderAsync(string flight_orderId)
        {
        ...
        /// <returns>Successful Operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Success_Booking> GetFlightOrderAsync(string flight_orderId, System.Threading.CancellationToken cancellationToken)
        {
            if (flight_orderId == null)
                throw new System.ArgumentNullException("flight_orderId");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("booking/flight-orders/{flight-orderId}");
