...
namespace AmadeusSdk.FlightCheckInLinks
{
    ...
    public partial class Client
    {
        ...
        public System.Threading.Tasks.Task<Success> GetCheckinURLsAsync(string airlineCode, string language)
        {
        ...
        /// <returns>Successful Operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Success> GetCheckinURLsAsync(string airlineCode, string language, System.Threading.CancellationToken cancellationToken)
        {
            if (airlineCode == null)
                throw new System.ArgumentNullException("airlineCode");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("reference-data/urls/checkin-links?");
