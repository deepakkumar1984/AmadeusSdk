...
namespace AmadeusSdk.NearestRelevantAirports
{
    ...
    public partial class Client
    {
        ...
        public System.Threading.Tasks.Task<Success> GetNearestRelevantAirportsAsync(double latitude, double longitude, int? radius, int? pagelimit, int? pageoffset, Sort? sort)
        {
        ...
        /// <returns>Successful Operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Success> GetNearestRelevantAirportsAsync(double latitude, double longitude, int? radius, int? pagelimit, int? pageoffset, Sort? sort, System.Threading.CancellationToken cancellationToken)
        {
            if (latitude == null)
            ...
            urlBuilder_.Append("reference-data/locations/airports?");
