...
namespace AmadeusSdk.FlightInspirationSearch
{
    ...
    public partial class Client 
    {
        ...
        public async System.Threading.Tasks.Task<FlightDestinations> GetFlightDestinationsAsync(string origin, string departureDate, bool? oneWay, string duration, bool? nonStop, long? maxPrice, ViewBy? viewBy, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/shopping/flight-destinations?");
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            ...
                            var result_ = default(FlightDestinations); 
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<FlightDestinations>(responseData_, _settings.Value);
                                return result_; 
                            } 
    ...
    public partial class FlightDestinations 
    {
        ...
        public static FlightDestinations FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<FlightDestinations>(data);
        }
    ...
    public partial class FlightDestination 
    {
        ...
        public static FlightDestination FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<FlightDestination>(data);
        }
