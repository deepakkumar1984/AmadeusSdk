...
namespace AmadeusSdk.FlightOrderManagement
{
    ...
    public partial class Client 
    {
        ...
        /// <summary>Retrieve a given flight order</summary>
        /// <param name="flight_orderId">identifier of the flight order</param>
        /// <returns>Successful Operation</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Response> GetFlightOrderAsync(string flight_orderId)
        {
            return GetFlightOrderAsync(flight_orderId, System.Threading.CancellationToken.None);
        }
        ...
        public async System.Threading.Tasks.Task<Response> GetFlightOrderAsync(string flight_orderId, System.Threading.CancellationToken cancellationToken)
        {
            if (flight_orderId == null)
                throw new System.ArgumentNullException("flight_orderId");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/booking/flight-orders/{flight-orderId}");
            urlBuilder_.Replace("{flight-orderId}", System.Uri.EscapeDataString(ConvertToString(flight_orderId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <summary>Cancel a given flight order</summary>
        /// <param name="flight_orderId">identifier of the flight order</param>
        /// <returns>Successfully Deleted</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task CancelFlightOrderAsync(string flight_orderId)
        {
            return CancelFlightOrderAsync(flight_orderId, System.Threading.CancellationToken.None);
        }
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task CancelFlightOrderAsync(string flight_orderId, System.Threading.CancellationToken cancellationToken)
        {
            if (flight_orderId == null)
                throw new System.ArgumentNullException("flight_orderId");
    ...
    public partial class FlightOrder 
    {
        ...
        public static FlightOrder FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<FlightOrder>(data);
        }
    ...
    public partial class TicketingAgreement 
    {
        ...
        public static TicketingAgreement FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TicketingAgreement>(data);
        }
    ...
    public partial class AutomatedProcessCommon 
    {
        ...
        public static AutomatedProcessCommon FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<AutomatedProcessCommon>(data);
        }
    ...
    public partial class AutomatedProcess : AutomatedProcessCommon
    {
        ...
        public static AutomatedProcess FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<AutomatedProcess>(data);
        }
    ...
    public partial class GeneralRemark 
    {
        ...
        public static GeneralRemark FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<GeneralRemark>(data);
        }
    ...
    public partial class AirlineRemark 
    {
        ...
        public static AirlineRemark FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<AirlineRemark>(data);
        }
    ...
    public partial class FormOfPayment 
    {
        ...
        public static FormOfPayment FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<FormOfPayment>(data);
        }
    ...
    public partial class B2bWallet 
    {
        ...
        public static B2bWallet FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<B2bWallet>(data);
        }
    ...
    public partial class CreditCardCommon 
    {
        ...
        public static CreditCardCommon FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CreditCardCommon>(data);
        }
    ...
    public partial class VirtualCreditCardDetails : CreditCardCommon
    {
        ...
        public static VirtualCreditCardDetails FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<VirtualCreditCardDetails>(data);
        }
    ...
    public partial class OtherMethod 
    {
        ...
        public static OtherMethod FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<OtherMethod>(data);
        }
    ...
    public partial class AssociatedRecordCommon 
    {
        ...
        public static AssociatedRecordCommon FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<AssociatedRecordCommon>(data);
        }
    ...
    public partial class AirTravelDocumentCommon 
    {
        ...
        public static AirTravelDocumentCommon FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<AirTravelDocumentCommon>(data);
        }
    ...
    public partial class AirTravelDocument : AirTravelDocumentCommon
    {
        ...
        public static AirTravelDocument FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<AirTravelDocument>(data);
        }
    ...
    public partial class ReportingData 
    {
        ...
        public static ReportingData FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ReportingData>(data);
        }
