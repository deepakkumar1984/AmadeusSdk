...
namespace AmadeusSdk.HotelRatings
{
    ...
    internal partial class Client
    {
        ...
        public System.Threading.Tasks.Task<SuccessSentiments> GetSentimentsByHotelIdsAsync(System.Collections.Generic.IEnumerable<string> hotelIds)
        {
        ...
        /// <returns>Successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<SuccessSentiments> GetSentimentsByHotelIdsAsync(System.Collections.Generic.IEnumerable<string> hotelIds, System.Threading.CancellationToken cancellationToken)
        {
            if (hotelIds == null)
                throw new System.ArgumentNullException("hotelIds");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("e-reputation/hotel-sentiments?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<SuccessSentiments>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "400") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Error400>(response_, headers_).ConfigureAwait(false);
                            throw new ApiException<Error400>("Not Found", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == "401") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Error401>(response_, headers_).ConfigureAwait(false);
                            throw new ApiException<Error401>("Unauthorized", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<Error500>(response_, headers_).ConfigureAwait(false);
                            throw new ApiException<Error500>("Unexpected Error", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                    }
                    finally
                    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.18.0 (Newtonsoft.Json v12.0.0.2)")]
    public partial class SuccessSentiments 
    {
